...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '007d73eb-914c-4105-9228-3962f75cb8f6' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('ce513ba7-9b86-44e6-990e-d7a37fbd32b9');
      cy.get(`[data-cy="name"]`).should('have.value', 'ce513ba7-9b86-44e6-990e-d7a37fbd32b9');

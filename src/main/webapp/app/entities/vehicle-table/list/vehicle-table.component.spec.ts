...
import { sampleWithRequiredData } from '../vehicle-table.test-samples';
...
describe('VehicleTable Management Component', () => {
  let comp: VehicleTableComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'vehicle-table', component: VehicleTableComponent }]),
      ...
      .overrideTemplate(VehicleTableComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.vehicleTables?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to vehicleTableService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getVehicleTableIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getVehicleTableIdentifier).toHaveBeenCalledWith(entity);

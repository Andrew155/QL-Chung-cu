...
import { sampleWithRequiredData } from '../fee-table.test-samples';
import { FeeTableService } from '../service/fee-table.service';

import { FeeTableComponent } from './fee-table.component';
import SpyInstance = jest.SpyInstance;

describe('FeeTable Management Component', () => {
  let comp: FeeTableComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'fee-table', component: FeeTableComponent }]),
      ...
      .overrideTemplate(FeeTableComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.feeTables?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to feeTableService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFeeTableIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFeeTableIdentifier).toHaveBeenCalledWith(entity);

...
import { sampleWithRequiredData } from '../room-table.test-samples';
import { RoomTableService } from '../service/room-table.service';

import { RoomTableComponent } from './room-table.component';
import SpyInstance = jest.SpyInstance;

describe('RoomTable Management Component', () => {
  let comp: RoomTableComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'room-table', component: RoomTableComponent }]),
      ...
      .overrideTemplate(RoomTableComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.roomTables?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to roomTableService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRoomTableIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRoomTableIdentifier).toHaveBeenCalledWith(entity);

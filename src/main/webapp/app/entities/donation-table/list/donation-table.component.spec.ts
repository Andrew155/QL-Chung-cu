...
import { sampleWithRequiredData } from '../donation-table.test-samples';
...
describe('DonationTable Management Component', () => {
  let comp: DonationTableComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'donation-table', component: DonationTableComponent }]),
      ...
      .overrideTemplate(DonationTableComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.donationTables?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to donationTableService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDonationTableIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDonationTableIdentifier).toHaveBeenCalledWith(entity);
